        ...
        <center>
            ...
            <section>
                <a href="formulpiquenique.php"><button type="button" style="color:rgb(233, 95, 16)"
                        href="formulpiquenique.php" class="btn btn-light">INSCRIPTION PIQUE-NIQUE</button></a>
            </section><br>

            <section>
                <a href="formulwarrior.php"><button type="button" style="color:rgb(233, 95, 16)"
                        href="formulwarrior.php" class="btn btn-light">INSCRIPTION CAROLO WARRIOR</button></a>
            </section><br>

            <section>
                <a href="formulcuisine.php"><button type="button" style="color:rgb(233, 95, 16)"
                        href="formulcuisine.php" class="btn btn-light">INSCRIPTION CONCOURS DE CUISINE</button></a>
            </section><br>
