        ...
        <div class="accordion" id="accordionExample">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        <p style=" line-height= 20px" ;>A travers les rues de Charleville-Mézières, le Carolo Express
                            ...
                            composer une équipe de 5 personnes.<br><br>
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="card-body">
                        <p>Carolo Warrior est un relai sportif composé de nombreuses activités sportives
                            ...
                            Horaires de la manifestation : 14H00<br>
            ...
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                    <div class="card-body">
                        <p>Pour ceux qui aiment cuisiner, un Concours de cuisine sera proposé sur la Place Ducale en
                            partenariat avec l’association INTERCampus.<br><br>
                            Sur la base de quelques ingrédients, vous devrez concocter un bon petit plat !
                            Plusieurs équipes s’affronteront. Le matériel minimum nécessaire sera mis à
                            disposition.<br><br>
                            Un jury à la fin notera et goûtera, pour le meilleur ou pour le pire, vos
                            préparations.<br><br>
                            Afin de participer à cette manifestation, il est nécessaire au préalable de
                            composer une équipe de 2 personnes.<br><br>
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        <p>Afin de passer tous ensemble une pause déjeuner conviviale, vous avez
                            ...
                            Horaires de la manifestation : À partir de 12H00<br>
                            Lieu : Plaine du Mont Olympe<br>
                            Info + : n’oubliez pas de prendre de la monnaie<br>

                        </p>
                        <center><a class="btn btn-warning" href="formulaire/formulpiquenique.php" role="button">S'inscrire</a>
                        </center>
