...
<center><h1 style="color:rgb(233, 95, 16)"> INSCRIPTION CONCOURS DE CUISINE </h1><br>
<p>Merci de remplir les champs ci-dessous pour inscrire votre équipe <br>
    et participer au concours de cuisine qui se déroulera Place Ducale et <br>
        ...
        <section>
                ...
                <section>
                      <a  href="formulexpress.php"><button type="button" role="button" style="color:rgb(233, 95, 16)"  class="btn btn-light">INSCRIPTION CAROLO EXPRESS</button></a>
                </section></br>
              
                <section>
                      <a href="formulpiquenique.php"><button type="button" role="button" style="color:rgb(233, 95, 16)"  class="btn btn-light">INSCRIPTION CAROLO PIQUE-NIQUE</button></a>
                </section></br>
              
                <section>
                      <a href="formulwarrior.php" ><button type="button" role="button" style="color:rgb(233, 95, 16)" class="btn btn-light">INSCRIPTION CAROLO WARRIOR</button></a>
                </section></br>
