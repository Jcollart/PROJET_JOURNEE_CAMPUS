    ...
    <div class="parallax-window" data-parallax="scroll" data-image-src="img/paracolor.jpg" alt="">
        ...
        <section class="new_edition" id="new_edition">
          <p style="padding-right:10px;padding-left:10px;"><font color="white">
            ...
            Merci d’avoir validé votre inscription !

            Celle-ci sera définitivement effective, une fois que tous vos coéquipiers auront validé leur participation.

            Merci de bien vouloir vérifier que tous les participants de votre équipe ont bien validé le lien reçu sur leur boite mail ! 
<br><br>
