...
<p>Merci de remplir les champs ci dessous pour inscrire votre équipe </br>
    et participer à la course d'orientation qui pourra vous permettre </br>
        de gagner des cadeaux en repondant à un questionnaire à travers </br>
          de la ville.
</p></center></br>
        ...
        <section>
                ...
                <section>
                        <button type="button" style="color:rgb(233, 95, 16)" class="btn btn-light">INSCRIPTION PIQUE-NIQUE</button>
                </section></br>
