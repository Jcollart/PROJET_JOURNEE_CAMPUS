            ...
            <article class="content">
                ...
                <div id="rev_slider_14_1_wrapper" class="rev_slider_wrapper fullscreen-container"
                    ...
                    <div id="rev_slider_14_1" class="rev_slider fullscreenbanner" style="display:none;"
                        ...
                        <ul>
                            <!-- SLIDE  -->
                            <li data-index="rs-32" data-transition="fade" data-slotamount="default"
                                ...
                                <!-- MAIN IMAGE -->
                                <img src="img/fond.jpg" data-bgcolor='#1d2931'' style=' background:#1d2931' alt=""
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-1" id="slide-32-layer-8"
                                    ...
                                    data-lineheight="['90','90','90','60']" data-width="none" data-height="none"
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-32-layer-2"
                                    data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['99','60','180','150']" data-width="none" data-height="none"
                                ...
                                <a class="tp-caption   tp-resizeme"
                                    ...
                                    data-lineheight="['25','25','25','20']" data-width="['none','none','none','320']"
                                ...
                                <div class="tp-caption tp-shape tp-shapewrapper  tp-resizeme" id="slide-32-layer-17"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['221','201','301','300']" data-width="['390','390','390','180']"
                                    data-height="2" data-whitespace="nowrap" data-type="shape"
                                    data-responsive_offset="on"
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-3" id="slide-32-layer-9"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['350','350','421','431']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                    ...
                                    <div class="rs-looped rs-wave" data-speed="5" data-angle="0" data-radius="3px"
                                        data-origin="50% 50%"><img src="img/confetti.gif" alt=""
                                            data-ww="['29px','29px','29px','29px']"
                                            data-hh="['21px','21px','21px','21px']" width="29" height="21"
                                            data-no-retina> </div>
                                </div>
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-3" id="slide-32-layer-10"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['399','399','408','438']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-5" id="slide-32-layer-11"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['338','338','331','348']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                    ...
                                    <div class="rs-looped rs-wave" data-speed="3" data-angle="0" data-radius="2px"
                                        data-origin="50% 50%"><img src="img/confetti.gif" alt=""
                                            data-ww="['26px','26px','26px','26px']"
                                            data-hh="['24px','24px','24px','24px']" width="26" height="24"
                                            data-no-retina> </div>
                                </div>
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-4" id="slide-32-layer-13"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['382','382','382','399']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                    ...
                                    <div class="rs-looped rs-wave" data-speed="6" data-angle="0" data-radius="3px"
                                        data-origin="50% 50%"><img src="img/confetti.gif" alt=""
                                            data-ww="['13','13','13','13px']" data-hh="12px" width="25" height="24"
                                            data-no-retina> </div>
                                </div>
                                ...
                                <div class="tp-caption   tp-resizeme rs-parallaxlevel-4" id="slide-32-layer-14"
                                    ...
                                    data-y="['bottom','bottom','bottom','bottom']"
                                    data-voffset="['300','300','300','366']" data-width="none" data-height="none"
                                    data-whitespace="nowrap" data-type="image" data-responsive_offset="on"
                                    ...
                                    <div class="rs-looped rs-wave" data-speed="7" data-angle="0" data-radius="6px"
                                        data-origin="50% 50%"><img src="img/confetti.gif" alt=""
                                            ...
                                            data-hh="['15px','15px','15px','15px']" width="27" height="26"
                                            data-no-retina> </div>
                                </div>
                ...
                <div class="carousel-item active">
                    <div class="card mb-3">
                        <div class="row no-gutters">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h1 class="card-title">Qu'est-ce que c'est?</h1>
