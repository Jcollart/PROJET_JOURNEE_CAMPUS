       ...
       <!-- SLIDER EXAMPLE -->
		...
		<ul>	<!-- SLIDE  -->
			<li data-index="rs-32" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
				<!-- MAIN IMAGE -->
				<img src="img/fond.jpg" data-bgcolor='#1d2931'' style='background:#1d2931' alt=""  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="off" class="rev-slidebg" data-no-retina>
				<!-- LAYERS -->
				...
				<div class="tp-caption   tp-resizeme" 
					...
					style="z-index: 5;"><img src="img/.png" alt="" data-ww="['full-proportional','full-proportional','full-proportional','full-proportional']" data-hh="['full-proportional','full-proportional','full-proportional','full-proportional']" width="1920" height="1280" data-no-retina> </div>
		...
		<div class="rs-looped rs-wave"  data-speed="3" data-angle="0" data-radius="2px" data-origin="50% 50%">LA JOURNEE<br/>DES ETUDIANTS </div></div>
		...
		<div class="rs-looped rs-wave"  data-speed="3" data-angle="0" data-radius="2px" data-origin="50% 50%">LA JOURNEE<br/>DES ETUDIANTS </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" 
					...
					style="z-index: 9; white-space: nowrap; font-size: 120px; line-height: 90px; font-weight: 700; color: rgba(255,255,255,1);font-family:Poppins;letter-spacing:-10px;">LA JOURNEE<br/>DES ETUDIANTS </div>

				<!-- LAYER NR. 6 -->
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-1" 
					 id="slide-32-layer-15" 
					 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
					 data-y="['bottom','bottom','bottom','bottom']" data-voffset="['19','0','100','120']" 
								data-width="none"
					data-height="none"
					data-whitespace="nowrap"
		...
		<div class="rs-looped rs-wave"  data-speed="5" data-angle="0" data-radius="3px" data-origin="50% 50%"><img src="img/eclair.png" alt="" data-ww="['709px','709px','709px','607px']" data-hh="['950px','950px','950px','900px']" width="407" height="200" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" 
					 id="slide-32-layer-2" 
					 data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
					 data-y="['bottom','bottom','bottom','bottom']" data-voffset="['99','60','180','150']" 
								data-width="none"
					data-height="none"
					data-whitespace="nowrap"
					...
					style="z-index: 11;">
		<div class="rs-looped rs-wave"  data-speed="10" data-angle="0" data-radius="5px" data-origin="50% 50%"><img src="img/mascotte.png" alt="" data-ww="['620px','518px','415px','210px']" data-hh="['600px','550px','500px','400px']" width="1025" height="500" data-no-retina> </div></div>
		 ...
		 href="https://revolution.themepunch.com/direct-customer-benefits/" target="_blank"			 id="slide-32-layer-16" 
					...
					style="z-index: 12; white-space: nowrap; font-size: 25px; line-height: 25px; font-weight: 300; color: rgba(255,255,255,1);font-family:Oswald;letter-spacing:10px;cursor:pointer;text-decoration: none;">L'EXPERIENCE COMMENCE MAINTENANT</a>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-3" 
					...
					style="z-index: 14;">
		<div class="rs-looped rs-wave"  data-speed="5" data-angle="0" data-radius="3px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['29px','29px','29px','29px']" data-hh="['21px','21px','21px','21px']" width="29" height="21" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-3" 
					...
					style="z-index: 15;">
		<div class="rs-looped rs-wave"  data-speed="5" data-angle="0" data-radius="3px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['28px','28px','28px','28px']" data-hh="['27px','27px','27px','27px']" width="28" height="27" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-5" 
					...
					style="z-index: 16;">
		<div class="rs-looped rs-wave"  data-speed="3" data-angle="0" data-radius="2px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['26px','26px','26px','26px']" data-hh="['24px','24px','24px','24px']" width="26" height="24" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-5" 
					...
					style="z-index: 17;">
		<div class="rs-looped rs-wave"  data-speed="5" data-angle="0" data-radius="4px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['27px','27px','27px','27px']" data-hh="['26px','26px','26px','26px']" width="27" height="26" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-4" 
					...
					style="z-index: 18;">
		<div class="rs-looped rs-wave"  data-speed="6" data-angle="0" data-radius="3px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['13','13','13','13px']" data-hh="12px" width="25" height="24" data-no-retina> </div></div>
				...
				<div class="tp-caption   tp-resizeme rs-parallaxlevel-4" 
					...
					style="z-index: 19;">
		<div class="rs-looped rs-wave"  data-speed="7" data-angle="0" data-radius="6px" data-origin="50% 50%"><img src="img/confetti.gif" alt="" data-ww="['16px','16px','16px','16px']" data-hh="['15px','15px','15px','15px']" width="27" height="26" data-no-retina> </div></div>
		 ...
		 href="https://revolution.themepunch.com/direct-customer-benefits/" target="_blank"			 id="slide-32-layer-18" 
					...
					style="z-index: 20; min-width: 270px; max-width: 270px; white-space: nowrap; font-size: 30px; line-height: 28px; font-weight: 300; color: rgba(255,255,255,1);font-family:Oswald;cursor:pointer;text-decoration: none;">UNE JOURNEE 100%<br/>ENRICHISSANTE </a>
		 ...
		 href="https://revolution.themepunch.com/direct-customer-benefits/#templatelibrary" target="_blank"			 id="slide-32-layer-19" 
					...
					style="z-index: 21; min-width: 270px; max-width: 270px; white-space: nowrap; font-size: 30px; line-height: 28px; font-weight: 300; color: rgba(255,255,255,1);font-family:Oswald;cursor:pointer;text-decoration: none;">DECOUVREZ TOUTES NOS<br/>ACTIVITEES DE LA JOURNEE </a>
		 ...
		 href="https://revolution.themepunch.com/examples/" target="_blank"			 id="slide-32-layer-20" 
					...
					style="z-index: 22; min-width: 270px; max-width: 270px; white-space: nowrap; font-size: 30px; line-height: 28px; font-weight: 300; color: rgba(255,255,255,1);font-family:Oswald;cursor:pointer;text-decoration: none;">REVIVEZ NOTRE<br/> EDITION 2018 </a>
				...
				<div class="tp-caption   tp-resizeme" 
					...
					style="z-index: 23; white-space: nowrap; font-size: 15px; line-height: 15px; font-weight: 300; color: rgba(12,17,21,1);font-family:Oswald;letter-spacing:10px;cursor:pointer;"></div>
			</li>
		</ul>
