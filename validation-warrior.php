...
$req = $bdd->prepare("SELECT cle, actif FROM warrior WHERE nom = :nom AND prenom = :prenom");
...
// La requête qui va passer notre champ actif de 0 à 1
         $req = $bdd->prepare("UPDATE warrior SET actif = 1 WHERE nom = :nom AND prenom = :prenom");
          ...
          $req = $bdd->prepare("SELECT nom_team FROM warrior where cle = :cle");
         ...
         if($req->execute(array(':cle' => $cle )) && $row = $req->fetch())
           ...
           $req = $bdd->prepare("SELECT count(*) AS nombreactif FROM warrior where actif=1 AND nom_team=:nom_team");
           ...
           if($req->execute(array(':nom_team' => $nomteam )) && $row = $req->fetch())
             {
               ...
               if ($nbactif==5) {
                 ...
                 $req2 = $bdd->prepare("SELECT email FROM warrior WHERE nom_team=:nom_team");
                 ...
                 if ($req2->execute(array(':nom_team' => $nomteam ))) {
                   ...
                   $Subject = "Rentree des etudiants – Inscription Carolo Warrior ";
