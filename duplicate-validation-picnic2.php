    ...
    <div class="parallax-window" data-parallax="scroll" data-image-src="img/paracolor.jpg" alt="">
        ...
        <section class="new_edition" id="new_edition">
          <p style="padding-right:10px;padding-left:10px;"><font color="white">
                    ...
                    Merci pour la réservation de votre repas. Celle-ci est bien enregistrée.<br>
                    Merci par avance à vous de venir, le jour J, avec la monnaie nécessaire pour régler sur place.<br><br>

                    Rendez-vous le 3 octobre !<br><br>
